...
ActiveRecord::Schema.define(version: 20180713072403) do
  ...
  create_table "company_informations", force: :cascade, comment: "企業情報" do |t|
  ...
  create_table "estimate_details", force: :cascade, comment: "見積明細" do |t|
    ...
    t.decimal "quantity", default: "0.0", null: false, comment: "数量"
    t.decimal "unit_price", default: "0.0", null: false, comment: "単価"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "estimates", force: :cascade, comment: "見積" do |t|
    t.bigint "company_information_id", comment: "企業情報ID"
    ...
    t.decimal "tax_rate", default: "0.0", null: false, comment: "発行時消費税率"
  ...
  create_table "products", force: :cascade, comment: "商品" do |t|
    ...
    t.decimal "default_price", default: "0.0", null: false, comment: "標準単価"
    t.bigint "company_information_id", comment: "企業情報ID"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "prospects", force: :cascade, comment: "案件" do |t|
    t.string "title", default: "", null: false, comment: "案件名"
    t.bigint "customer_id", comment: "顧客ID"
    t.integer "rank", default: 0, null: false, comment: "商談ランク"
    t.decimal "prospect_amount", default: "0.0", null: false, comment: "案件想定金額"
  ...
  create_table "sales_reports", force: :cascade, comment: "営業報告" do |t|
    t.bigint "company_information_id", comment: "企業情報ID"
    t.bigint "customer_id", comment: "顧客ID"
  ...
  create_table "user_profiles", force: :cascade, comment: "ユーザ" do |t|
  ...
  create_table "users", force: :cascade, comment: "ユーザアカウント" do |t|
